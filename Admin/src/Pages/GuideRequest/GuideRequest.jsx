...
const GuideRequest = () => {
    ...
    useEffect(() => {
        ...
        const fetchRequests = async () => {
            try {
                const response = await axios.get('https://api.iirhe.org.in/api/all-guide-contact');
    ...
    const deleteRecord = async (id) => {
        ...
        if (result.isConfirmed) {
            try {
                const response = await axios.delete(`https://api.iirhe.org.in/api/delete-guide-contact/${id}`);
